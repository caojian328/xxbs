...
public class SQLHelper {
    ...
    public static int getCount(final String sql, final Connection connection,
        ...
        final String countSql = "select count(*) from (" + removeOrders(sql) + ") tmp_count";
...
//        final String countSql = "select count(1) " + removeSelect(removeOrders(sql));
     ...
     * @return 分页SQL
     */
    public static String generatePageSql(String sql, PagerModel page, Dialect dialect) {
	...
	private static String removeOrders(String qlString) {  
        ...
        Pattern p = Pattern.compile("order\\s*by[\\w|\\s|[(,)(.)]]*", Pattern.CASE_INSENSITIVE);
